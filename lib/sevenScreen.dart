                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                ...
                                height: 90,
                                decoration: BoxDecoration(
                                    shape: BoxShape.circle, color: Color(0xff767673)),
                                child: CircleAvatar(
                                  radius: 15,
                                  backgroundImage:
                                  AssetImage("imageFile/mon.PNG"),
                                ),
                              ),
                              Container(
                                margin: EdgeInsets.fromLTRB(7, 20, 7, 0),
                                ...
                                child: CircleAvatar(
                                  radius: 15,
                                  backgroundImage:
                                  AssetImage("imageFile/settingdog2.png"),
                                ),
                              ),
                              Container(
                                margin: EdgeInsets.fromLTRB(7, 20, 7, 0),
